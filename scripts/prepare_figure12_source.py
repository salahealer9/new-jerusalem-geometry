#!/usr/bin/env python3
"""Render Michell's Figure 12 source page and record provenance.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "Figure 12 and record its provenance."
        )
    )
    ...
    parser.add_argument(
        ...
        default=65,
        help=(
            "One-based PDF page number containing Figure 12. "
            "Default: 65."
        ),
    )
...
def main() -> int:
    ...
    print("Figure 12 source preparation")
    print("=" * 28)
